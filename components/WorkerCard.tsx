      ...
      <div className="p-6">
        <div className="flex items-start gap-4 mb-5">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-0.5 truncate">{profile.firstName} {profile.lastName}</h3>
            <p className="text-sm font-medium text-primary-600 dark:text-primary-400 mb-1">{profile.category}</p>
        ...
        <div className="flex items-center justify-between py-3 border-t border-slate-100 dark:border-slate-700">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-sm font-semibold text-slate-900 dark:text-white">{profile.avgRating.toFixed(1)}</span>
            <span className="text-xs text-slate-500 dark:text-slate-400">({profile.reviewCount} reviews)</span>
          </div>
