    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <h3 className="text-lg font-semibold text-gray-900">Post delen</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-2">
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Deel via WhatsApp</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Deel op Facebook</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Tweet deze post</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Deel op LinkedIn</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Verstuur via e-mail</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">
                {copied ? 'Link is naar klembord gekopieerd' : 'Kopieer link naar klembord'}
              </div>
            </div>
          </button>
        </div>
