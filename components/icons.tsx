...
export const VerifiedIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const VcaIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const LocationIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      fillRule="evenodd"
      d="M11.54 22.351l.07.04.028.016a.76.76 0 0 0 .723 0l.028-.015.071-.041a2.25 2.25 0 0 0 .286-.17c1.172-.724 2.86-2.286 4.53-4.542 1.67-2.257 2.54-4.863 2.54-7.653C22.25 6.26 18.04 2 12 2S1.75 6.26 1.75 11.75c0 2.79.87 5.396 2.54 7.653 1.67 2.256 3.358 3.818 4.53 4.542.14.086.257.14.348.182l.006.003.012.006.02.01.022.01.02.008.01.004.01.003h.002a.75.75 0 0 0 .416 0h.002l.01-.003.01-.004.02-.008.022-.01.02-.01.012-.006.006-.003a2.35 2.35 0 0 0 .348-.182Z"
      clipRule="evenodd"
    />
  </svg>
);
...
export const MoonIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25c0 5.385 4.365 9.75 9.75 9.75 2.572 0 4.92-.99 6.697-2.648Z"
    />
  </svg>
);
...
export const BriefcaseIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M20.25 14.15v4.075c0 1.313-.964 2.505-2.263 2.741a48.717 48.717 0 0 1-3.473 0c-1.3-.236-2.263-1.428-2.263-2.741V14.15m6.026 0v-1.32a3.75 3.75 0 0 0-3.75-3.75h-1.5a3.75 3.75 0 0 0-3.75 3.75v1.32m6.026 0h-6.026m0 0H4.498c-1.39 0-2.525.98-2.525 2.192v.266c0 1.212 1.135 2.192 2.525 2.192h3.026M12 14.15v4.075c0 1.313.964 2.505 2.263 2.741a48.717 48.717 0 0 0 3.473 0c1.3-.236 2.263-1.428 2.263-2.741V14.15"
    />
  </svg>
);
...
export const AcademicCapIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    ...
    className={className}
  >
    <path d="M12 14.25c-2.43 0-4.63.63-6.5 1.74a1.5 1.5 0 0 0-1 1.41V18a1.5 1.5 0 0 0 1.5 1.5h13a1.5 1.5 0 0 0 1.5-1.5v-.6a1.5 1.5 0 0 0-1-1.41c-1.87-1.1-4.07-1.74-6.5-1.74Z" />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 14.25c-4.97 0-9-1.12-9-2.5s4.03-2.5 9-2.5 9 1.12 9 2.5-4.03 2.5-9 2.5Z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 14.25V21m0-13.5V3M21 9l-9 6-9-6"
    />
  </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.495-2.495a1.125 1.125 0 0 1 1.591 1.591l-2.495 2.495M11.42 15.17 1.5 21m10.5-10.5a.375.375 0 1 1-1.591 1.591M11.25 10.5a.375.375 0 1 1 1.591 1.591M15 11.25a.375.375 0 1 1 1.591-1.591M15.75 10.5a.375.375 0 1 1-1.591-1.591M14.25 12.75a.375.375 0 1 1-1.591 1.591M15 12.75a.375.375 0 1 1 1.591 1.591"
    />
  </svg>
);
...
export const PaintBrushIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 9.75v6.75m0-6.75h.008v.008H12V9.75Zm.008 6.75h.008v.008h-.008v-.008Zm0 0H12m6.02-6.02a1.5 1.5 0 0 0-1.801-1.932l-2.5 1.25a1.5 1.5 0 0 1-1.44-.06l-2.75-1.75a1.5 1.5 0 0 0-1.58.283l-2.75 2.5a1.5 1.5 0 0 0-.282 1.58l1.75 2.75a1.5 1.5 0 0 1 .06 1.44l-1.25 2.5a1.5 1.5 0 0 0 1.932 1.802l6.02-3.01Z"
    />
  </svg>
);
...
export const ClipboardList: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const Mail: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z"
    />
  </svg>
);
...
export const Image: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909M18 12v4.5A2.25 2.25 0 0 1 15.75 18.75H5.25A2.25 2.25 0 0 1 3 16.5V7.5A2.25 2.25 0 0 1 5.25 5.25h13.5A2.25 2.25 0 0 1 21 7.5V12"
    />
  </svg>
);
...
// Premium Feed Icons (2025 Edition)
...
export const MoreHorizontal: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
