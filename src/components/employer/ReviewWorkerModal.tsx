  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createReview({
        ...
        punctuality_rating: punctualityRating > 0 ? punctualityRating : undefined,
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              💡 <strong>Twoja opinia pomaga innym pracodawcom!</strong> Wypełnij formularz szczegółowo, 
              aby ułatwić przyszłym klientom decyzję o współpracy z tym pracownikiem.
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg space-y-4">
            <h3 className="font-semibold text-gray-900 mb-3">Oceny szczegółowe (opcjonalne)</h3>
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">{comment.length} znaków</p>
          </div>
