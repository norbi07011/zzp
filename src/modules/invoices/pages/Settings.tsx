...
export default function Settings({ onNavigate }: SettingsProps) {
  ...
  const { company, updateCompany, createCompany, loading } = useSupabaseCompany(user?.id || '');
      ...
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-8 text-white shadow-2xl">
          ...
          <div className="relative">
            ...
            <p className="text-indigo-100 text-lg">Ustawienia firmy i konfiguracja</p>
          </div>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-yellow-800 mb-3">
                  Musisz najpierw utworzyć profil firmy, aby móc wystawiać faktury. 
                  Wypełnij poniższy formularz i kliknij "Zapisz ustawienia".
                </p>
        ...
        {/* Logo Upload */}
        <Card className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🖼️ Logo firmy</h2>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-700 mt-1">
                  Dodaj logo swojej firmy, które będzie wyświetlane na wszystkich fakturach w lewym górnym rogu. 
                  Zalecany format: <strong>PNG lub JPG</strong>, maksymalny rozmiar: <strong>2MB</strong>.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <h4 className="font-semibold text-gray-900 mb-2">📋 Wskazówki:</h4>
        ...
        {/* Company Info */}
        <Card className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🏢 Dane firmy</h2>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Strona internetowa</label>
                <Input
                  type="url"
        ...
        {/* Tax & Legal Info */}
        <Card className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">📋 Dane podatkowe i prawne</h2>
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Numer KVK (NL)</label>
                <Input
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Numer VAT/BTW *</label>
                <Input
            ...
            <div className="bg-yellow-50 p-4 rounded-xl border-2 border-yellow-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-gray-900">Format numeru VAT</div>
                  <div className="text-sm text-gray-700 mt-1">
                    NL: <code className="bg-white px-2 py-1 rounded">NL123456789B01</code> • 
                    PL: <code className="bg-white px-2 py-1 rounded">PL1234567890</code> • 
                    DE: <code className="bg-white px-2 py-1 rounded">DE123456789</code>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Bank Details */}
        <Card className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🏦 Dane bankowe</h2>
          
          <div className="bg-blue-50 p-4 rounded-xl border-2 border-blue-200 mb-4">
            <div className="flex items-start gap-3">
              <span className="text-2xl">📱</span>
              <div>
                <div className="font-bold text-gray-900">QR kod płatności SEPA</div>
                <div className="text-sm text-gray-700 mt-1">
                  Gdy podasz IBAN, na fakturach pojawi się <strong>kolorowy QR kod</strong> do szybkiej płatności. 
                  Klienci mogą zeskanować kod telefonem i zapłacić bez przepisywania danych!
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-blue-50 p-4 rounded-xl border-2 border-blue-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-700 mt-1">
                    Dane IBAN i BIC są używane do generowania kodów QR SEPA na fakturach dla szybkich płatności
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Invoice Defaults */}
        <Card className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">📄 Domyślne ustawienia faktur</h2>
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Domyślna stawka VAT (%)</label>
                <select
                  value={formData.default_vat_rate}
                  onChange={(e) => setFormData({ ...formData, default_vat_rate: parseInt(e.target.value) })}
                  className="flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm"
                >
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Waluta</label>
                <select
