...
export const STRIPE_CONFIG = {
  ...
  products: {
    ...
    workerPremium: {
      ...
      description: 'Maandelijks abonnement: Meer zichtbaarheid, prioriteit in zoekresultaten'
    },
    ...
    employerBasic: {
      ...
      description: 'Basis toegang tot platform - 50 searches, 5 contacten per maand'
    },
    ...
    employerPremium: {
      ...
      description: 'Volledige toegang - Unlimited searches, contacten, Premium workers'
    }
  },
