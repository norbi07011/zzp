-- ============================================
-- INSERT ALL TEST JOBS - Single File
-- ============================================
-- Wklej w Supabase SQL Editor aby dodać wszystkie 3 test jobs naraz
-- Employer 1: test-employer@example.com (e15f1bef-4268-49c4-ad4f-788494342b9d)
-- Employer 2: lenavalentinaaa@gmail.com (8a17942f-7209-469a-bafc-1a748d195eef)

-- JOB 1: Metselaar - Amsterdam (Featured)
INSERT INTO jobs (
  ...
  'Wij zoeken een ervaren metselaar voor diverse bouwprojecten in Amsterdam en omgeving. Je werkt zelfstandig en in teamverband aan nieuwbouw- en renovatieprojecten.',
  'Ervaren metselaar voor projecten in Amsterdam',
  'metselaar', 'full-time', 'on-site', 'Amsterdam', '1012AB', 'NL',
  2500, 3500, 'EUR', 'month', true,
  'mid',
...
-- JOB 3: Timmerman - Utrecht (Hybride, Part-time)
INSERT INTO jobs (
  id, employer_id, title, description, short_description,
  category, employment_type, location_type, city, postal_code, country,
  salary_min, salary_max, salary_currency, salary_period, salary_visible,
