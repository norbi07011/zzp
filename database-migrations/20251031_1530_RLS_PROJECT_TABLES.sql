-- ============================================
-- MIGRATION: RLS dla tabel projektowych (PRIORYTET 2)
-- Date: 2025-10-31
-- Author: AI Copilot
-- Verified: Column names checked via terminal (check-project-tables.mjs)
-- ============================================
...
-- (project_invites i project_chat_messages już mają RLS - tylko enable)

BEGIN;

-- ============================================
-- QUICK WINS: Tabele z istniejącymi policies
-- ============================================

-- 1. project_invites - ma już 6 policies, tylko enable RLS
ALTER TABLE project_invites ENABLE ROW LEVEL SECURITY;

-- 2. project_chat_messages - ma już 4 policies, tylko enable RLS
ALTER TABLE project_chat_messages ENABLE ROW LEVEL SECURITY;

-- ============================================
-- 3. PROJECTS - główna tabela projektów
...
-- ============================================
-- 5. PROJECT_TASKS - zadania projektowe
...
-- ============================================
-- 6. PROJECT_CHAT_GROUPS - grupy czatowe
...
-- KONIEC MIGRACJI
-- ============================================
SELECT '✅ MIGRATION COMPLETE: RLS enabled for 6 project tables' as status;
