...
import { Profile, Job, Level, Availability, JobRateType, Review, User, Application, ApplicationStatus, VerificationSlot, VerificationBooking, Course, CourseType, Enrollment, Plan, Notification, UserRole } from './types';

export const MOCK_USERS: User[] = [
    { id: 1, email: 'worker@test.com', name: 'Jan Kowalski', role: 'worker', subscription: { planId: 'worker-plus', status: 'ACTIVE' } },
    { id: 2, email: 'worker2@test.com', name: 'Piotr Nowak', role: 'worker', subscription: { planId: 'worker-basic', status: 'ACTIVE' } },
    { id: 3, email: 'worker3@test.com', name: 'Anna Zielińska', role: 'worker', subscription: { planId: 'worker-basic', status: 'INACTIVE' } },
    { id: 4, email: 'client@test.com', name: 'Bouwbedrijf Jansen', role: 'client', subscription: { planId: 'client-pro', status: 'ACTIVE' } },
    { id: 5, email: 'client2@test.com', name: 'Design Huis', role: 'client', subscription: { planId: 'client-basic', status: 'ACTIVE' } },
...
const MOCK_APPROVED_REVIEWS_JAN: Review[] = [
  { 
    ...
    date: '2023-09-15', 
    rating: 5, 
    comment: 'Jan to prawdziwy profesjonalista. Praca wykonana perfekcyjnie i na czas. Polecam!', 
...
const MOCK_APPROVED_REVIEWS_PIOTR: Review[] = [
    { 
        ...
        date: '2023-10-20', 
        rating: 5, 
        comment: 'Piotr jest rzetelnym i kompetentnym fachowcem. Wszystko działa idealnie.', 
...
export const MOCK_PROFILES: Profile[] = [
  {
    ...
    experience: [
      { company: 'Budimex S.A.', title: 'Stolarz Budowlany', startDate: '2010-03', endDate: '2022-08', description: 'Realizacja projektów stolarskich na dużych budowach, praca z dokumentacją techniczną.' },
      { company: 'Własna działalność', title: 'Stolarz Meblowy', startDate: '2022-09', endDate: 'Obecnie', description: 'Projektowanie i wykonywanie mebli na indywidualne zamówienie klienta.' }
    ],
    gallery: [
      { title: 'Kuchnia na wymiar', description: 'Nowoczesna kuchnia w dębie', images: ['https://picsum.photos/seed/kuchnia1/400/300', 'https://picsum.photos/seed/kuchnia2/400/300'], tags: ['Dąb', 'MDF'], date: '2023-05' },
      { title: 'Zabudowa tarasu', description: 'Taras z drewna egzotycznego', images: ['https://picsum.photos/seed/taras1/400/300'], tags: ['Drewno egzotyczne'], date: '2023-08' }
    ],
    certificates: [
      { name: 'VCA VOL', validUntil: '2025-12-10', verified: true },
      { name: 'Certyfikat czeladniczy', validUntil: 'Bezterminowo', verified: true }
    ],
  ...
  },
  {
    ...
    experience: [
      { company: 'NRG-Solutions', title: 'Elektromonter', startDate: '2018-01', endDate: '2023-12', description: 'Praca przy instalacjach elektrycznych w obiektach komercyjnych i mieszkalnych.' }
    ],
    gallery: [
      { title: 'Instalacja w nowym domu', description: 'Pełna instalacja elektryczna od A do Z', images: ['https://picsum.photos/seed/dom1/400/300', 'https://picsum.photos/seed/dom2/400/300'], tags: ['NEN 1010', 'Inteligentny dom'], date: '2023-11' }
    ],
    certificates: [
  ...
  },
   {
    ...
    experience: [
      { company: 'Pomocnik na budowie', title: 'Pracownik ogólnobudowlany', startDate: '2022-05', endDate: '2023-10', description: 'Wykonywanie prostych prac wykończeniowych i pomocniczych.' }
    ],
    gallery: [],
    certificates: [],
...
export const MOCK_JOBS: Job[] = [
    {
        ...
        peopleNeeded: 2,
        requiredCerts: ['VCA'],
        description: 'Poszukujemy dwóch doświadczonych stolarzy do montażu kuchni oraz mebli w nowo budowanym apartamentowcu. Wymagane doświadczenie w pracy z rysunkiem technicznym i własne podstawowe narzędzia.',
        isPriority: true,
    },
    {
        id: 2,
        ...
        description: 'Duży projekt - wykonanie pełnej instalacji elektrycznej w nowym biurowcu w centrum Rotterdamu. Praca w zespole, wymagane uprawnienia i doświadczenie w obiektach komercyjnych.',
        isPriority: false,
    },
    {
        id: 3,
        ...
        peopleNeeded: 1,
        requiredCerts: [],
        description: 'Zlecenie na wyszpachlowanie i pomalowanie ścian i sufitów w domu jednorodzinnym (ok. 150m2 powierzchni). Materiały po stronie zleceniodawcy. Poszukujemy osoby dokładnej i terminowej.',
        isPriority: false,
    }
];

export const MOCK_APPLICATIONS: Application[] = [
    { id: 1, jobId: 2, workerId: 1, date: '2024-07-10', status: ApplicationStatus.New },
    { id: 2, jobId: 2, workerId: 2, date: '2024-07-11', status: ApplicationStatus.Shortlisted },
];
...
export const MOCK_COURSES: Course[] = [
    { id: 'vca-b-1', title: 'VCA Basis', type: 'VCA_BASIS', price: 199, dates: ['2024-08-10', '2024-08-11'], seatLimit: 10 },
    { id: 'vca-v-1', title: 'VCA VOL', type: 'VCA_VOL', price: 249, dates: ['2024-08-17', '2024-08-18'], seatLimit: 8 },
];
...
export const MOCK_PLANS: Plan[] = [
    { id: 'worker-basic', name: 'Worker Basic', role: 'worker', price: 0, perks: ['Publiczny profil', 'Dostęp do tablicy ogłoszeń', 'Aplikowanie na 5 ofert miesięcznie'] },
    { id: 'worker-plus', name: 'Worker Plus', role: 'worker', price: 15, perks: ['Wszystko co w Basic', 'Nielimitowane aplikacje', 'Promowanie profilu', 'Dostęp do statystyk'] },
    { id: 'client-basic', name: 'Client Basic', role: 'client', price: 0, perks: ['Publikacja 1 ogłoszenia miesięcznie', 'Przeglądanie profili', 'Moderacja opinii do 72h'] },
    { id: 'client-pro', name: 'Client Pro', role: 'client', price: 49, perks: ['Wszystko co w Basic', 'Nielimitowane ogłoszenia', 'Promowanie ofert', 'Priorytetowa moderacja opinii (<24h)'] },
];

export const MOCK_NOTIFICATIONS: Notification[] = [
    { id: 'notif1', userId: 4, type: 'NEW_APPLICATION', message: 'Jan Kowalski zaaplikował na Twoją ofertę "Instalacje elektryczne w biurowcu"', isRead: false, timestamp: new Date().toISOString() }
]
