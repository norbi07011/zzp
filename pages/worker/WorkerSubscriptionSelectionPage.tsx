      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-8 max-w-3xl mx-auto">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-blue-900 text-lg mb-2">Hoe werkt het?</h3>
              <ul className="space-y-2 text-sm text-blue-800">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                  <span><strong>Basic (€0):</strong> Je kunt gratis registreren en je profiel invullen, maar werkgevers zien je NIET in zoekresultaten. Geen zichtbaarheid = geen contacten.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                  <span><strong>Premium (€13/maand):</strong> Je profiel wordt zichtbaar voor werkgevers, je krijgt hogere positie in zoekopdrachten, en je kunt opdrachten ontvangen.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                  <span><strong>Je kunt altijd upgraden!</strong> Start met Basic en upgrade later naar Premium wanneer je klaar bent.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div
            className={`bg-white rounded-2xl shadow-lg overflow-hidden border-2 transition-all cursor-pointer ${
              selectedPlan === 'basic' ? 'border-orange-500 ring-4 ring-orange-200' : 'border-gray-200 hover:border-orange-300'
            }`}
            ...
            <div className="p-6">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Profiel aanmaken en beheren</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">ZZP Certificaat aanvragen (€230)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-500 line-through">Zichtbaar voor werkgevers</span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-500 line-through">Werkgevers zien je profiel NIET</span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-500 line-through">Contact van werkgevers ontvangen</span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-500 line-through">Opdrachten ontvangen</span>
                </li>
              </ul>
          ...
          <div
            className={`bg-white rounded-2xl shadow-xl overflow-hidden border-2 transition-all cursor-pointer relative ${
              selectedPlan === 'premium' ? 'border-orange-500 ring-4 ring-orange-200' : 'border-orange-300 hover:border-orange-500'
            }`}
          ...
          >
            ...
            <div className="bg-gradient-to-r from-orange-500 to-yellow-500 p-6 text-center text-white">
              ...
              <p className="mt-2 text-sm text-orange-100">Volledige zichtbaarheid</p>
            </div>
            ...
            <div className="p-6">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700 font-semibold">Alles van Basic +</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Volledig zichtbaar</strong> voor werkgevers</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Hogere positie</strong> in zoekresultaten</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Premium badge</strong> op je profiel</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Ontvang contactverzoeken</strong> van werkgevers</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Direct opdrachten ontvangen</strong></span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>E-mail notificaties</strong> bij nieuwe opdrachten</span>
                </li>
              </ul>
        ...
        <div className="mt-12 max-w-3xl mx-auto bg-white rounded-xl shadow-md p-8">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            <div>
              <p className="font-semibold">Kan ik later upgraden naar Premium?</p>
              <p className="text-gray-600">Ja! Je kunt altijd upgraden via je dashboard. Je betaalt dan vanaf dat moment €13/maand.</p>
            </div>
            <div>
              <p className="font-semibold">Kan ik Premium opzeggen?</p>
              <p className="text-gray-600">Ja, je kunt je Premium abonnement op elk moment opzeggen. Je profiel blijft dan beschikbaar maar wordt niet meer zichtbaar voor werkgevers.</p>
            </div>
            <div>
              <p className="font-semibold">Wat gebeurt er als ik Basic kies?</p>
              <p className="text-gray-600">Je krijgt toegang tot het platform en kunt je profiel invullen, maar werkgevers zien je NIET in hun zoekresultaten. Je ontvangt geen opdrachten tot je upgrade naar Premium.</p>
            </div>
            <div>
              <p className="font-semibold">Is het ZZP Certificaat (€230) inbegrepen?</p>
              <p className="text-gray-600">Nee, het ZZP Certificaat is een aparte betaling van €230 (€190 + BTW). Dit certificaat krijg je na een fysiek examen op locatie.</p>
            </div>
          </div>
        </div>
