...
type SettingsSection = 'account' | 'notifications' | 'privacy' | 'payments' | 'preferences';
...
export const Settings: React.FC = () => {
  ...
  const ToggleSwitch: React.FC<{ enabled: boolean; onChange: () => void; label: string; description?: string }> = ({ 
    ...
    const ariaLabel = `${label} - obecnie ${enabled ? 'włączone' : 'wyłączone'}`;
        ...
        <div className="flex-1">
          <div className="bg-white rounded-xl shadow-lg p-6">
            {activeSection === 'account' && (
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-6">Ustawienia konta</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="settings-phone" className="block text-sm font-medium text-gray-700 mb-2">Telefon</label>
                    <input
                      id="settings-phone"
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="settings-language" className="block text-sm font-medium text-gray-700 mb-2">Język</label>
                    <select
            ...
            {activeSection === 'notifications' && (
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-6">Powiadomienia</h2>
            ...
            {activeSection === 'privacy' && (
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-6">Prywatność i bezpieczeństwo</h2>
                
                <div className="space-y-6">
                  <div>
                    <label htmlFor="settings-visibility" className="block text-sm font-medium text-gray-700 mb-2">Widoczność profilu</label>
                    <select
                    ...
                    >
                      ...
                      <option value="clients-only">Tylko klienci - widoczny dla zarejestrowanych klientów</option>
                      <option value="private">Prywatny - niewidoczny w wyszukiwarkach</option>
                    </select>
                  </div>
                  ...
                  <div className="space-y-1 divide-y divide-gray-200">
                    ...
                    <ToggleSwitch
                      ...
                      onChange={() => setSettings({ ...settings, allowDirectBooking: !settings.allowDirectBooking })}
            ...
            {activeSection === 'payments' && (
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-6">Metody płatności</h2>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <h3 className="font-semibold text-gray-900 mb-4">Historia płatności</h3>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between py-2">
                      <div>
                        <p className="font-medium text-gray-900">Subskrypcja Worker Plus</p>
                        <p className="text-sm text-gray-600">15 stycznia 2025</p>
                      </div>
            ...
            {activeSection === 'preferences' && (
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <label htmlFor="settings-theme" className="block text-sm font-medium text-gray-700 mb-2">Motyw</label>
                    <select
                      id="settings-theme"
                  ...
                  <div className="space-y-1 divide-y divide-gray-200">
                    ...
                    <ToggleSwitch
                      ...
                      onChange={() => setSettings({ ...settings, showTips: !settings.showTips })}
          ...
          <div className="mt-6 bg-red-50 rounded-xl border border-red-200 p-6">
            <h3 className="text-lg font-bold text-red-900 mb-2">Strefa niebezpieczna</h3>
