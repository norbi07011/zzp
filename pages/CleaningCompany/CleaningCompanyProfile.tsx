      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Wype┼énij formularz aby pracodawcy mogli Ci─Ö znale┼║─ç na podstawie dost─Öpno┼¢ci
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* KALENDARZ DOST─ÿPNO┼ÜCI - NAJWA┼╗NIEJSZA SEKCJA! */}
          <section className="bg-blue-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
              <span>≡ƒôà</span>
              Twoja dost─Öpno┼¢─ç (kluczowe!)
            </h2>
            <p className="text-sm text-gray-600 mb-4">
              Zaznacz dni, w kt├│re mo┼╝esz przyj┼¢─ç do pracy. Pracodawcy b─Öd─à mogli filtrowa─ç firmy wed┼éug dost─Öpno┼¢ci.
            </p>
          ...
          <div className="flex gap-4">
            ...
            >
              {formData.profile_visibility === 'public' ? '≡ƒæü∩╕Å Profil publiczny' : '≡ƒöÆ Profil prywatny'}
            </button>
          </div>
        </form>
      </div>
