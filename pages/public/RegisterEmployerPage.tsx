...
import { validateStep, validateFull, type EmployerRegistrationData } from '../../schemas/employerRegistration';
...
export const RegisterEmployerPage = () => {
  ...
  const handleInputChange = (field: keyof EmployerRegistrationData, value: string | boolean) => {
    ...
    } else if (currentStep === 2 && ['contactPerson', 'email', 'phone'].includes(field)) {
      setTimeout(() => validateStepSecure(2), 500);
    } else if (currentStep === 3 && ['password', 'confirmPassword'].includes(field)) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Registreer uw bedrijf</h1>
          <p className="text-gray-600">Krijg toegang tot onze database van geverifieerde ZZP professionals</p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between max-w-md mx-auto mt-2 text-xs text-gray-600 font-medium">
            <span className={currentStep === 1 ? 'text-blue-600 font-bold' : ''}>Bedrijfsgegevens</span>
            <span className={currentStep === 2 ? 'text-blue-600 font-bold' : ''}>Contactpersoon</span>
            <span className={currentStep === 3 ? 'text-blue-600 font-bold' : ''}>Beveiliging</span>
          </div>
        </div>
        ...
        <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-4 mb-6 max-w-2xl mx-auto">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="font-bold text-amber-900 mb-1">Belangrijk: Alleen voor bedrijven</p>
              <p className="text-sm text-amber-800">
                Deze registratie is uitsluitend voor opdrachtgevers. ZZP'ers kunnen zich niet zelf registreren.
                Zij ontvangen toegang na het slagen van de praktijktest.
              </p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {currentStep === 1 && (
              <div className="space-y-6 animate-fade-in">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Formaat: NL + 9 cijfers + B + 2 cijfers</p>
                </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-6 animate-fade-in">
                  ...
                  {formData.password && (
                    <div className="mt-2">
                      ...
                      <p className="text-xs text-gray-500">
                        Tip: Gebruik letters, cijfers en speciale tekens voor een sterk wachtwoord
                      </p>
                    </div>
                  )}
                </div>
                ...
                {/* Terms & Conditions */}
                <div className={`border rounded-lg p-4 ${errors.agreedToTerms ? 'border-red-500 bg-red-50' : 'border-gray-200 bg-gray-50'}`}>
                  <label className="flex items-start cursor-pointer">
                    ...
                    <span className="ml-3 text-sm text-gray-700">
                      ...
                      <Link to="/legal#terms" className="text-blue-600 hover:text-blue-700 font-medium" target="_blank">
                        algemene voorwaarden
                      </Link>{' '}
                      en{' '}
                      <Link to="/legal#privacy" className="text-blue-600 hover:text-blue-700 font-medium" target="_blank">
                        privacyverklaring
                      </Link>
                    </span>
                  </label>
