...
import { 
  CheckCircle, Users, FileText, Calculator, Star, Shield, 
  TrendingUp, Zap, MessageCircle, Award, Search, Clock,
  DollarSign, Target, Briefcase, ChevronRight, Check
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-dark via-primary-navy to-primary-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <div className="flex justify-center">
          <div className="gradient-glass p-2 rounded-xl inline-flex gap-2">
            <button
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">🚀 Hoe Registreren & Starten</h2>
          </div>
          ...
          <div className="mb-8 grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl overflow-hidden border-4 border-green-500/30 shadow-2xl transform hover:scale-105 transition-transform">
              ...
              <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-4 text-center">
                <p className="text-white font-bold">Word onderdeel van ons netwerk!</p>
              </div>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden border-4 border-emerald-500/30 shadow-2xl transform hover:scale-105 transition-transform">
              ...
              <div className="bg-gradient-to-r from-emerald-600 to-green-600 p-4 text-center">
                <p className="text-white font-bold">Start vandaag met je profiel</p>
              </div>
            </div>
          </div>
          ...
          {[
            { step: '1', icon: FileText, title: 'Registreer', desc: 'Klik "Registreer als ZZP\'er" en vul basis info in' },
            { step: '2', icon: Briefcase, title: 'Profiel Info', desc: 'Voeg specialisatie, stad, uurloon en ervaring toe' },
            { step: '3', icon: Shield, title: 'Account', desc: 'Maak wachtwoord en accepteer voorwaarden' },
            { step: '4', icon: CheckCircle, title: 'Verificatie', desc: 'Bevestig email en log in op platform' },
            { step: '5', icon: Star, title: 'Portfolio', desc: 'Upload certificaten en bouw je profiel uit' }
          ].map((item, idx) => (
            <div key={idx} className="bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-all">
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">💰 Abonnementen - Basic vs Premium</h2>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="bg-white/5 p-8 rounded-xl border-2 border-gray-700">
            ...
            <div className="text-4xl font-bold text-gray-400 mb-6">€0<span className="text-lg">/maand</span></div>
            <ul className="space-y-3">
              {[
                { text: 'Niet zichtbaar voor opdrachtgevers', included: false },
                ...
                <li key={idx} className="flex items-start gap-3">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${item.included ? 'bg-green-500' : 'bg-red-500/20'}`}>
                    {item.included ? <Check size={14} className="text-white" /> : <span className="text-red-400">✕</span>}
                  </div>
                  <span className={item.included ? 'text-white' : 'text-gray-400'}>{item.text}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 p-8 rounded-xl border-2 border-green-500 relative">
            ...
            <div className="text-4xl font-bold text-green-400 mb-6">€13<span className="text-lg">/maand</span></div>
            <ul className="space-y-3">
              {[
            ...
            <div className="mt-6 p-4 bg-green-500/10 rounded-lg border border-green-500/30">
              <p className="text-green-400 text-sm font-semibold">💡 TIP: Start met Premium om direct opdrachten te krijgen!</p>
            </div>
          </div>
        </div>
        </div>
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">👥 Team Configuratie</h2>
          </div>
          ...
          <div className="mb-8 rounded-2xl overflow-hidden border-2 border-purple-500/30 bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-8">
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex gap-2">
                {[...Array(2)].map((_, i) => (
                  <div key={i} className="w-12 h-12 rounded-full bg-gradient-to-br from-green-500 to-emerald-500 border-4 border-green-400/50 flex items-center justify-center">
              ...
              <div className="grid grid-cols-3 gap-1">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 border-2 border-purple-400/50 flex items-center justify-center">
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">⚡ Skoczek - Beschikbaar Nu</h2>
          </div>
            ...
            <div className="md:col-span-2 rounded-2xl overflow-hidden border-2 border-yellow-500/30 bg-gradient-to-br from-yellow-900/20 to-orange-900/20 p-6">
              <div className="flex items-center justify-center gap-12">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-yellow-400 text-sm font-bold">Toggle ON</span>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-yellow-400 font-bold">Beschikbaar Nu! ⚡</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Wat is Skoczek?</h3>
            <ul className="space-y-3">
              {[
          ...
          <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 p-6 rounded-xl border border-yellow-500/30">
            <h4 className="text-lg font-bold text-white mb-4">Hoe gebruik je het?</h4>
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">🏆 ZZP Examen & Certificaat</h2>
          </div>
          ...
          <div className="mb-8 grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl overflow-hidden border-4 border-yellow-500/30 shadow-2xl transform hover:scale-105 transition-transform">
              ...
              <div className="bg-gradient-to-r from-yellow-600 to-orange-600 p-4 text-center">
                <p className="text-white font-bold">📚 Bereid je voor op het examen</p>
              </div>
            </div>
          ...
          <div className="mb-8 rounded-2xl overflow-hidden border-2 border-yellow-600/30 bg-gradient-to-br from-yellow-900/20 to-orange-900/20 p-6">
            <div className="relative bg-gradient-to-br from-yellow-600 to-orange-600 rounded-xl p-8 border-4 border-yellow-400/50">
              <div className="text-center text-white">
                ...
                <p className="text-yellow-100 mb-4">Officieel erkend vakmanschap</p>
          ...
          <div className="bg-white/5 p-6 rounded-xl">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <ChevronRight className="text-yellow-400 flex-shrink-0 mt-1" size={16} />
                <span className="text-gray-300">Optioneel examen (60 vragen, 90 min)</span>
              </li>
              <li className="flex items-start gap-3">
                <ChevronRight className="text-yellow-400 flex-shrink-0 mt-1" size={16} />
              ...
              <li className="flex items-start gap-3">
                <ChevronRight className="text-yellow-400 flex-shrink-0 mt-1" size={16} />
                <span className="text-gray-300">Bij slagen: Officieel certificaat + 1 jaar Premium GRATIS (€156 waarde!)</span>
              </li>
            </ul>
          </div>

          <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 p-6 rounded-xl border border-yellow-500/30">
            <h3 className="text-xl font-bold text-white mb-4">Waarom doen?</h3>
            <ul className="space-y-3">
              {[
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">📊 Dashboard Functies</h2>
          </div>
          ...
          <div className="mb-8 rounded-2xl overflow-hidden border-4 border-blue-500/30 shadow-2xl transform hover:scale-105 transition-transform">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-4 text-center">
              <p className="text-white font-bold">📈 Volledige controle over je ZZP carrière</p>
            </div>
          </div>

        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {[
            { icon: TrendingUp, title: 'Statistieken', desc: 'Bekijk profielweergaves en contacten' },
            { icon: FileText, title: 'Profiel Bewerken', desc: 'Update uurloon, portfolio, beschikbaarheid' },
            { icon: MessageCircle, title: 'Berichten', desc: 'Lees en beantwoord employer berichten' },
            { icon: Shield, title: 'Instellingen', desc: 'Wijzig wachtwoord en notificaties' },
            { icon: DollarSign, title: 'Abonnement', desc: 'Upgrade naar Premium of annuleer' },
            { icon: Zap, title: 'Skoczek Toggle', desc: 'Schakel beschikbaarheid aan/uit' }
          ].map((item, idx) => (
            <div key={idx} className="bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-all">
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">❓ FAQ voor ZZP'ers</h2>
          </div>
          ...
          <div className="mb-8 grid md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2 rounded-xl overflow-hidden border-2 border-pink-500/30 bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-6 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Vragen? We helpen je graag!</h3>
                <p className="text-purple-200">Bekijk de meest gestelde vragen hieronder</p>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10">
          ...
          <div className="mb-8 grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl overflow-hidden border-4 border-blue-500/30 shadow-2xl transform hover:scale-105 transition-transform">
              ...
              />
              <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-4 text-center">
                <p className="text-white font-bold">🤝 Vind de perfecte ZZP'er voor jouw project</p>
              </div>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden border-4 border-cyan-500/30 shadow-2xl transform hover:scale-105 transition-transform">
              ...
              <div className="bg-gradient-to-r from-cyan-600 to-blue-600 p-4 text-center">
                <p className="text-white font-bold">✨ Direct toegang tot duizenden professionals</p>
              </div>
            </div>
          </div>
          ...
          {[
            { step: '1', title: 'Klik Registreer', desc: 'Als Opdrachtgever' },
            { step: '2', title: 'Bedrijfsgegevens', desc: 'Naam, KVK, contact' },
            { step: '3', title: 'Email Verificatie', desc: 'Bevestig account' },
            { step: '4', title: 'Kies Abonnement', desc: 'Basic €13 of Premium €25' },
            { step: '5', title: 'Betaal via Stripe', desc: 'Card of iDEAL' },
            { step: '6', title: 'Direct Toegang', desc: 'Zoek ZZP\'ers!' }
          ].map((item, idx) => (
            <div key={idx} className="bg-white/5 p-4 rounded-xl hover:bg-white/10 transition-all text-center">
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-8 rounded-2xl overflow-hidden border-4 border-green-500/30 shadow-2xl transform hover:scale-105 transition-transform">
            ...
            />
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-4 text-center">
              <p className="text-white font-bold">💼 Kies het abonnement dat bij jouw bedrijf past</p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="bg-white/5 p-8 rounded-xl border-2 border-blue-500">
            <h3 className="text-2xl font-bold text-white mb-2">Basic</h3>
            <div className="text-4xl font-bold text-blue-400 mb-6">€13<span className="text-lg">/maand</span></div>
            <ul className="space-y-3">
              {[
          ...
          <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 p-8 rounded-xl border-2 border-cyan-500 relative">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Premium</h3>
            <div className="text-4xl font-bold text-cyan-400 mb-6">€25<span className="text-lg">/maand</span></div>
            <ul className="space-y-3">
              {[
                'Alles in Basic +',
                'Unlimited contacten',
            ...
            <div className="mt-6 p-4 bg-cyan-500/10 rounded-lg border border-cyan-500/30">
              <p className="text-cyan-400 text-sm font-semibold">💡 TIP: Premium voor bedrijven die 5+ ZZP'ers/maand boeken!</p>
            </div>
          </div>
          </div>
        </div>
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">🔍 Hoe Zoek je ZZP'ers?</h2>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {[
            { icon: Briefcase, title: 'Specialisatie Filter', desc: 'Metselaar, Timmerman, Elektricien, etc.' },
            { icon: Target, title: 'Locatie Filter', desc: 'Zoek op stad/postcode met radius' },
            { icon: DollarSign, title: 'Tarief Filter', desc: 'Slider: €15 - €75/uur binnen budget' },
            { icon: Users, title: 'Team Size Filter', desc: 'Individueel, Duo, Team (3-10)' },
            { icon: Zap, title: 'Skoczek Filter', desc: 'Alleen nu beschikbare ZZP\'ers' },
            { icon: Award, title: 'Certificering Filter', desc: 'Alleen ZZP Exam geslaagden' },
            { icon: Star, title: 'Rating Filter', desc: 'Minimum 3★, 4★, 5★ alleen' },
            { icon: Clock, title: 'Beschikbaarheid', desc: 'Datum/tijd beschikbaarheid' }
          ].map((item, idx) => (
            <div key={idx} className="bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-all">
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">💬 Contact & Teams Boeken</h2>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          <div className="bg-white/5 p-6 rounded-xl">
            <h3 className="text-xl font-bold text-white mb-4">Contact Opnemen</h3>
            <ol className="space-y-3">
              {[
            ...
            <div className="mt-4 p-3 bg-yellow-500/10 rounded-lg border border-yellow-500/30">
              <p className="text-yellow-400 text-sm"><strong>Limits:</strong> Basic: 5/maand | Premium: Unlimited</p>
            </div>
          </div>

          <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 p-6 rounded-xl border border-purple-500/30">
            <h3 className="text-xl font-bold text-white mb-4">Teams Boeken</h3>
            ...
            <div className="p-3 bg-purple-500/10 rounded-lg border border-purple-500/30">
              ...
              <p className="text-gray-300 text-sm">"Loodgieter Team - 1 senior + 2 assistenten"<br/>€120/uur (vs 3×€50 = €150/uur apart!)</p>
            </div>
          </div>
          </div>
        </div>
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">💰 Kosten Besparen - Calculator</h2>
          </div>
          ...
          <div className="mb-8 grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl overflow-hidden border-4 border-green-500/30 shadow-2xl transform hover:scale-105 transition-transform">
              ...
              />
              <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-4 text-center">
                <p className="text-white font-bold">💸 Bespaar duizenden euro's per jaar!</p>
              </div>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden border-2 border-emerald-500/30 bg-gradient-to-br from-green-900/30 to-emerald-900/30 p-6 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Slim Rekenen</h3>
                <p className="text-green-200">Transparante prijzen zonder verborgen kosten</p>
              </div>
            </div>
          </div>

        <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 p-8 rounded-xl border border-green-500/30 mt-8">
          <h3 className="text-2xl font-bold text-white mb-6 text-center">Hoeveel bespaar je vs traditioneel?</h3>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-red-500/10 p-6 rounded-xl border border-red-500/30">
              <h4 className="text-lg font-bold text-red-400 mb-4">TRADITIONEEL BUREAU (20% commissie)</h4>
              <div className="space-y-2 text-gray-300">
                <p>€2.000 × 10 projecten = €20.000</p>
                <p>Commissie 20% = <strong className="text-red-400">€4.000</strong></p>
              </div>
            </div>

            <div className="bg-green-500/10 p-6 rounded-xl border border-green-500/30">
              <h4 className="text-lg font-bold text-green-400 mb-4">ZZP WERKPLAATS (Premium)</h4>
              <div className="space-y-2 text-gray-300">
                <p>€25 × 12 maanden = €300</p>
                <p>Totaal kosten = <strong className="text-green-400">€300</strong></p>
              </div>
            </div>
          </div>

          <div className="mt-6 p-6 bg-green-500 rounded-xl text-center">
            <p className="text-2xl font-bold text-white">💰 JE BESPAART: €3.700/jaar! ✅</p>
          </div>
          </div>
        </div>
      </section>
      ...
      <section className="gradient-glass p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">❓ FAQ voor Opdrachtgevers</h2>
          </div>
          ...
          <div className="mb-8 rounded-2xl overflow-hidden border-4 border-blue-500/30 shadow-2xl transform hover:scale-105 transition-transform">
            ...
            />
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-4 text-center">
              <p className="text-white font-bold">🤝 We helpen je graag verder met al je vragen!</p>
            </div>
          </div>
