  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <Link
        to="/faktury"
        onClick={() => {
          console.log("🧾 FAKTURY BUTTON CLICKED - Dashboard: ACCOUNTANT");
        }}
        className="block bg-green-600 text-white rounded-lg shadow-xl p-6 hover:bg-green-700 transition-all hover:shadow-2xl mb-6"
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-green-100">
              Twój prywatny program do faktur i VAT
            </p>
          </div>
        </div>
      </Link>
